    ...
    <Layout title="Inbox">
      ...
      <div className="bg-white shadow-md h-full p-8">
        ...
        <p className="text-gray-500 leading-7 font-thin text-xs mt-6">
          ...
          neque. Arcu cursus vitae congue mauris rhoncus aenean vel elit scelerisque. Varius quam
          quisque id diam vel quam elementum pulvinar etiam. At in tellus integer feugiat
          scelerisque varius morbi enim nunc. Neque egestas congue quisque egestas. Lorem ipsum
          dolor sit amet consectetur. Pellentesque pulvinar pellentesque habitant morbi tristique
          senectus et netus. Leo integer malesuada nunc vel. Sit amet cursus sit amet dictum sit
          amet justo donec. Porta nibh venenatis cras sed.
          <br />
          <br />
