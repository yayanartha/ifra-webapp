  ...
  return (
    <div className="flex pl-8" style={{ height: '535px' }}>
      ...
      <div style={{ width: '448px' }}>
        <div className="px-8 overflow-y-auto pt-4 pb-8" style={{ height: '450px' }}>
        ...
        <div className="pl-4">
          <div
            className="border-t border-gray-200 flex items-center justify-end pr-8"
            style={{ height: '80px' }}
          >
            <PrimaryButton onClick={() => {}} label="Save" width="200px" />
          </div>
        </div>
      </div>
    </div>
